...
export default function EmbedConfigPage({ params }: EmbedConfigPageProps) {
  ...
  const [showTypingIndicator, setShowTypingIndicator] = useState(embed?.settings?.showTypingIndicator !== false);
  const [requireUserEmail, setRequireUserEmail] = useState(embed?.settings?.requireUserEmail !== false);
  const [enableEmoji, setEnableEmoji] = useState(embed?.settings?.enableEmoji !== false);
  
  // Add state for requested advanced options
  const [allowAttachments, setAllowAttachments] = useState(embed?.settings?.allowAttachments || false);
  const [showBranding, setShowBranding] = useState(embed?.settings?.showBranding !== false);
  const [enableMarkdown, setEnableMarkdown] = useState(embed?.settings?.enableMarkdown !== false);
  const [enableCodeHighlighting, setEnableCodeHighlighting] = useState(embed?.settings?.enableCodeHighlighting !== false);
  const [rateLimitEnabled, setRateLimitEnabled] = useState(embed?.settings?.rateLimit?.enabled || false);
  const [maxRequestsPerHour, setMaxRequestsPerHour] = useState(embed?.settings?.rateLimit?.maxRequestsPerHour || 100);
                        ...
                        <div className="grid gap-4 py-4">
                          ...
                          <div className="grid gap-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              This prompt sets the behavior and capabilities of the AI. It's not visible to users but guides how the AI responds.
                            </p>
                          </div>
                          ...
                          <div className="grid gap-2">
                            ...
                            <Slider
                              ...
                              onValueChange={(values) => setMaxTokensPerMessage(values[0])}
                            />
                            <p className="text-xs text-muted-foreground">
                              Maximum number of tokens the AI can use in a single response.
                            </p>
                          </div>
                          ...
                          <div className="grid gap-2">
                            ...
                            <Slider
                              ...
                              onValueChange={(values) => setMessageHistory(values[0])}
                            />
                            <p className="text-xs text-muted-foreground">
                    ...
                    <Card className="mb-6">
                      ...
                      <CardContent>
                        <div className="grid gap-4 py-4">
                          ...
                          <div className="grid gap-2">
                            <div className="flex items-center justify-between">
                              <Label htmlFor="requireUserEmail">Require User Email</Label>
                              <Switch
                                id="requireUserEmail"
                                checked={requireUserEmail}
                                onCheckedChange={setRequireUserEmail}
                              />
                            </div>
                            <p className="text-xs text-muted-foreground">
                              When enabled, users will be asked for their email before starting a chat.
                            </p>
                          </div>
                          ...
                          <div className="grid gap-2">
                            <div className="flex items-center justify-between">
                              <Label htmlFor="enableEmoji">Enable Emoji Support</Label>
                              <Switch
                                id="enableEmoji"
                                checked={enableEmoji}
                            ...
                            <p className="text-xs text-muted-foreground">
                              Allow emoji rendering in messages.
                            </p>
                          </div>
                        </div>
                      </CardContent>
                      ...
                      <CardContent>
                        <div className="grid gap-4 py-4">
                          <div className="grid gap-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              Allow users to upload and attach files in the chat.
                            </p>
                          </div>
                          ...
                          <div className="grid gap-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              Display "Powered by AITIY" branding in the chat widget.
                            </p>
                          </div>
                          ...
                          <div className="grid gap-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              Enable markdown formatting in AI responses.
                            </p>
                          </div>
                          
                          <div className="grid gap-2">
                            <div className="flex items-center justify-between">
                              <Label htmlFor="enableCodeHighlighting">Code Highlighting</Label>
                              <Switch
                            ...
                            <p className="text-xs text-muted-foreground">
                              Enable syntax highlighting for code blocks in responses.
                            </p>
                          </div>
                            ...
                            {rateLimitEnabled && (
                              <div className="mt-2">
                                ...
                                <Slider
                                  ...
                                  onValueChange={(values) => setMaxRequestsPerHour(values[0])}
                                  className="mt-2"
                                />
                              </div>
                            )}
                            <p className="text-xs text-muted-foreground">
                              Limit the number of requests a user can make per hour.
                            </p>
                          </div>
                        </div>
                      </CardContent>
