            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">AITIY</span>
                  ...
                  <div className="space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <Link href="/auth/login">
                      <Button
                        size="lg"
                        variant="outline"
                        className="w-full sm:w-auto bg-white bg-opacity-20 text-white hover:bg-opacity-30 border-transparent"
                      >
                        Sign in
                      </Button>
                    </Link>
            ...
            <div className="mt-20">
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="mt-6 text-xl font-medium text-gray-900">Easy Integration</h3>
                  <p className="mt-2 text-base text-gray-500 text-center">
                    Simple copy-and-paste integration with any website or application.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="mt-6 text-xl font-medium text-gray-900">Analytics & Insights</h3>
                  <p className="mt-2 text-base text-gray-500 text-center">
                    Track usage, analyze conversations, and improve your chat experience.
                  </p>
                </div>
              </div>
            </div>
