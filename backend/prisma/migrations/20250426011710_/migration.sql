...
CREATE TABLE "ChatEmbed" (
    ...
    CONSTRAINT "ChatEmbed_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ChatEmbed" ADD CONSTRAINT "ChatEmbed_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
